...
public class VerticalNavItemListBuilder {
	...
	public static VerticalNavItemListWrapper add(VerticalNavItem verticalNavItem) {
		VerticalNavItemListWrapper verticalNavItemListWrapper = new VerticalNavItemListWrapper();
	...
	public static VerticalNavItemListWrapper add(
		UnsafeSupplier<Boolean, Exception> unsafeSupplier, VerticalNavItem verticalNavItem) {
